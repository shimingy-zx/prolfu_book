...
local function TextToSpeechRawBinary(Text)
    return game:HttpGetAsync(HttpService:JSONDecode(game:HttpPostAsync("https://ttsmp3.com/makemp3_new.php",
        "msg=" .. HttpService:UrlEncode(Text) .. string.format("&lang=%s&source=ttsmp3", CurrentSpeaker),
